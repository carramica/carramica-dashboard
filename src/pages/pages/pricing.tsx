            ...
            <div className="grid gap-8 lg:grid-cols-3">
              <div>
                ...
                <div className="mb-10">
                  ...
                  <p className="mb-4 text-gray-600 dark:text-gray-400">
                    We are aware of the importance of well qualified support,
                ...
                <div className="mb-10">
                  ...
                  <p className="mb-4 text-gray-600 dark:text-gray-400">
                    ...
                    whether it is a personal website, a SaaS app, or a website
                    for a client. As long as you do not build a product that
                    will directly compete with FlowBite either as a UI kit,
                    theme, or template, it is fine.
                  </p>
                  <p className="mb-4 text-gray-600 dark:text-gray-400">
              ...
              <div>
                ...
                <div className="mb-10">
                  ...
                  <p className="mb-4 text-gray-600 dark:text-gray-400">
                    ...
                    commercial business, whether it is a SaaS, an e-commerce
                ...
                <div className="mb-10">
                  ...
                  <p className="mb-4 text-gray-600 dark:text-gray-400">
                    If you forgot to complete the information, or you did not
              ...
              <div>
                <div className="mb-10">
                  ...
                  <p className="mb-4 text-gray-600 dark:text-gray-400">
                    You will be one of the first to know when it will be
                    available.
                  </p>
                </div>
                <div className="mb-10">
                  ...
                  <p className="mb-4 text-gray-600 dark:text-gray-400">
                    ...
                    &nbsp;within 30 days and we will issue a full refund.
                  </p>
                </div>
                <div className="mb-10">
                  <h3 className="mb-4 text-lg font-medium text-gray-900 dark:text-white">
                ...
                <div className="mb-10">
                  ...
                  <p className="mb-4 text-gray-600 dark:text-gray-400">
                    ...
                    will be able to see a text Add VAT code. Click on that, and
                    add the VAT code for your company. This will also remove the
